...
<body>
                    ...
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                             ...
                             <script>
                                ...
                                var countDownDate = new Date("Jun 26, 2018 00:00:00").getTime();
                                ...
                                var x = setInterval(function() {
                                    ...
                                    if (distance < 0) {
                                        clearInterval(x);
                                        document.getElementById("demo").innerHTML = "Time left: "+"EXPIRED";
                                    }
                                }, 1000);
                              </script>
                        </div>
    ...
    <!--<div class="footer">
            ...
            <div class="row">
                <div class="col-lg-12" >
                       Design by: <a href="#" style="color:#fff;" target="_blank">Salim Shadman Ankur</a>
                </div>
            </div>
        </div>-->
      <div class="footer">
