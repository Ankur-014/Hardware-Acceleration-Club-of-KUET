     ...
     <?php include 'navi.php'?>
        ...
        <div id="page-wrapper" >
            ...
            <div>
              ...
              <form method="post">Search: <input type="text" id="txt1" placeholder="Comment" name="name2" onkeyup="showHint(this.value)">
              ...
              <?php
                  ...
                  {
                    $user   = $_POST['name2'];
                    $query2 = "SELECT * from tbl_cmnt";
                    $result1 = $db->select($query2);
                    $xw = "<b>Not Found</b>";
                    while($result2 = $result1->fetch_assoc()){

                      if($result2['message']===$user){
                        $id = $result2['id'];
                        $sql = "DELETE from tbl_cmnt where id = '$id'";
                        $sql1 = $db->delete($sql);
                        if($sql1)                        
